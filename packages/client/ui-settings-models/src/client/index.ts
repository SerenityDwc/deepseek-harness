...
export function apply(ctx: ClientContext): void {
  ...
  // The settings scope persistence (loopback or IP-literal Host vs DNS-named
  // remote) keeps a remote DNS browser process-local, so the store needs no
  // isLoopback branch of its own.
